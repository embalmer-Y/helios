...
- top_proactive_dispositions: ['defer=27', 'externalize=7', 'reflect=2']
- top_trigger_sources: ['drive:curiosity=86', 'emotion:FEAR=84', 'disposition:defer=54', 'neurochem:exploration=47', 'drive:aesthetic=44']
- top_deferred_reasons: ['best_candidate_below_threshold=29', 'within_comfort_band=6']
- top_action_drop_reasons: []
- action_explicit_samples: 0
- equivalent_bridge_evidence_samples: 9
- implicit_action_proposal_samples: 9
...
- peak_governance_pressure_score: 0.757
...
- continuation_active_ratio: 0.447
...
- proactive disposition summary: defer=27, externalize=7, reflect=2
- proactive trigger summary: drive:curiosity=86, emotion:FEAR=84, disposition:defer=54, neurochem:exploration=47, drive:aesthetic=44
- deferred trace summary: best_candidate_below_threshold=29, within_comfort_band=6
...
- implicit action proposals observed=9
- equivalent bridge evidence observed=9
