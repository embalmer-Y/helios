...
- helios: 说白了，就是既想露脸又怕丢脸，绷着一股劲，怕一松手全塌了。
- user: 如果我嫌你刚才那句有点像套话，你会怎么改得更像正常聊天？
- helios: 那是你问得太绕了吧。直接说“别跟我打官腔”不行吗？
...
- top_proactive_dispositions: ['externalize=17', 'reflect=10', 'explore=9']
- top_trigger_sources: ['neurochem:exploration=105', 'neurochem:initiative=101', 'drive:curiosity=80', 'emotion:SEEKING=50', 'continuation=42']
- top_deferred_reasons: ['within_comfort_band=32', 'best_candidate_below_threshold=4']
...
- peak_governance_pressure_score: 0.986
...
- proactive disposition summary: externalize=17, reflect=10, explore=9
- proactive trigger summary: neurochem:exploration=105, neurochem:initiative=101, drive:curiosity=80, emotion:SEEKING=50, continuation=42
- deferred trace summary: within_comfort_band=32, best_candidate_below_threshold=4
