...
| --- | --- | --- | --- |
| `gap_behavioral_consequence_binding` | Internal activation and committed content can still overstate system quality when downstream visible behavior remains weak | Brain-like claims are weak if internal state does not reliably shape externally consequential action or inaction | `17`, `18` |
