...
class DashboardState:
    ...
    def update(self, **kwargs):
        with self._lock:
            # Backward compatibility: accept 'phi' key and map to 'icri'
            if "phi" in kwargs and "icri" not in kwargs:
                kwargs["icri"] = kwargs.pop("phi")
            elif "phi" in kwargs and "icri" in kwargs:
                kwargs.pop("phi")  # icri takes precedence
            ...
            entry = {
                ...
                "label": self.label,
                "icri": round(self.icri, 4),
                "phi": round(self.icri, 4),  # backward compat for monitoring tools
    ...
    def _run(self):
        ...
        while self.running:
            ...
            if self.phi_engine and state.panksepp_activation:
                ...
                update_kwargs["icri"] = self.phi_engine.aggregate()
            else:
                update_kwargs["icri"] = 0.0
