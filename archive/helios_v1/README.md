...
> Deprecated and archived on 2026-06-02.
> This legacy runtime is no longer the active development target.
> The active implementation branch is `helios_v2/` at the repository root.

## Archive Status

This directory contains the archived Helios v1 codebase.

It is preserved for historical reference, migration context, and old artifact lookup only.

Do not continue feature development here.

For active architecture, implementation, and requirement work, use `helios_v2/`.
