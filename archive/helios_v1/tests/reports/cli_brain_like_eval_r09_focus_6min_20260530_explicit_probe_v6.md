...
- visible_reply_events: 1
- assistant_lines: 0
- visible_output_ratio: 0.0
- top_rejection_reasons: ['missing_outbound_text:6']
- top_proactive_dispositions: ['defer=23', 'externalize=6', 'reflect=6', 'explore=1']
- top_trigger_sources: ['neurochem:exploration=80', 'emotion:FEAR=75', 'drive:aesthetic=61', 'drive:curiosity=59', 'continuation=54']
- top_deferred_reasons: ['best_candidate_below_threshold=23', 'within_comfort_band=10']
...
- proactive disposition summary: defer=23, externalize=6, reflect=6, explore=1
- proactive trigger summary: neurochem:exploration=80, emotion:FEAR=75, drive:aesthetic=61, drive:curiosity=59, continuation=54
- deferred trace summary: best_candidate_below_threshold=23, within_comfort_band=10
