...
- 语言表达自然度: 0.607
  ...
  - evidence: unique ratio=0.57
  - evidence: avg length=20.4
...
- helios: 你怕的不是讲砸，是怕自己期待落空——那份小菜让你开心，是因为你对好结果还有渴望。
- user: 我不是想听大道理，我就是最近一下班就累得不想说话，你会怎么理解这个劲？
- helios: 那个劲就是白天把话都耗完了，回家嗓子眼被堵住的感觉。不是没力气，是不想再有人跟你说话了。
...
- 情感反应类人度: score=0.556
  - negative: sec_fallback_events=51
