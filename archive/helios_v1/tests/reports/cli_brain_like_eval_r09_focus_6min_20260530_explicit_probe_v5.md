...
- top_proactive_dispositions: ['externalize=19', 'explore=9', 'reflect=9']
- top_trigger_sources: ['neurochem:exploration=105', 'neurochem:initiative=99', 'drive:curiosity=84', 'emotion:SEEKING=43', 'continuation=40']
- top_deferred_reasons: ['within_comfort_band=34', 'best_candidate_below_threshold=2']
- top_action_drop_reasons: []
- action_explicit_samples: 1
- equivalent_bridge_evidence_samples: 4
- implicit_action_proposal_samples: 4
...
- proactive disposition summary: externalize=19, explore=9, reflect=9
- proactive trigger summary: neurochem:exploration=105, neurochem:initiative=99, drive:curiosity=84, emotion:SEEKING=43, continuation=40
- deferred trace summary: within_comfort_band=34, best_candidate_below_threshold=2
...
- implicit action proposals observed=4
- equivalent bridge evidence observed=4
